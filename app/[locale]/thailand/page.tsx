...
const attractions = [
  ...
  ['Chiang Mai i Wat Phra That Doi Suthep', 'Północna Tajlandia', '/images/thailand/phra-that-doi-suthep.jpg', 'Stolica północy, otoczona górami i setkami świątyń. Na szczycie góry Doi Suthep znajduje się Wat Phra That Doi Suthep – jedna z najważniejszych świątyń w regionie, z której roztacza się widok na całe miasto.'],
...
const regions = [
  ...
  ['Północ (Chiang Mai, Chiang Rai)', 'Góry, kultura, słynna Biała Świątynia i spokojniejsze tempo.', '/images/thailand/phra-that-doi-suthep.jpg'],
...
const gallery = [
  ['Zachód słońca nad plażą w Phuket', '/images/thailand/phuket.jpg'], ['Złote prangi Wat Arun w Bangkoku', '/images/thailand/boats.jpg'], ['Leżący Budda w Wat Pho', '/images/thailand/elephants.jpg'], ['Ruiny świątyń w Ayutthaya', '/images/thailand/ayutthaya.jpg'], ['Widok na Chiang Mai z Doi Suthep', '/images/thailand/phra-that-doi-suthep.jpg'], ['Wapienne klify zatoki Phang Nga', '/images/thailand/island.jpg'], ['Targ pływający Damnoen Saduak', '/images/thailand/boats.jpg'], ['Biała Świątynia w Chiang Rai', '/images/thailand/phra-that-doi-suthep.jpg'], ['Plaża Maya Bay na wyspach Phi Phi', '/images/thailand/koh-samet.jpg'], ['Rybacka wioska w Bophut na Koh Samui', '/images/thailand/koh-sak.jpg'], ['Tropikalny las w Parku Narodowego Khao Sok', '/images/thailand/koh-mak.jpg'], ['Nocny Bangkok z rzeki Chao Phraya', '/images/thailand/walking-street.jpg']
] as const;
