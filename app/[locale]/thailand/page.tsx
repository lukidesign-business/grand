  ...
  return (
    <>
      ...
      <Advantages dict={dict}>
        <div className="on-photo reveal mt-12 border border-line bg-[linear-gradient(140deg,rgba(201,162,90,.09),rgba(16,19,24,.6))] p-8 text-center text-[var(--fixed-cream)] md:mt-20 md:p-12">
          <h3 className="mb-3 text-[clamp(1.6rem,3vw,2.2rem)]">{t.ctaTitle}</h3>
          <p className="mx-auto mb-8 max-w-[52ch] text-[var(--fixed-muted)]">{t.ctaBody}</p>
          <Button asChild variant="gold">
