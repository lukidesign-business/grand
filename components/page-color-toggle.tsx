...
export function PageColorToggle({ darkLabel, lightLabel }: { darkLabel: string; lightLabel: string }) {
  ...
  return (
    <button
      ...
      title={label}
      onClick={toggleTheme}
      className="inline-flex size-11 items-center justify-center border border-gold/60 bg-ink/90 text-gold shadow-lg backdrop-blur-sm transition-all duration-300 hover:border-gold-bright hover:bg-ink hover:text-gold-bright focus-visible:outline-2 focus-visible:outline-offset-3 focus-visible:outline-gold-bright"
    >
