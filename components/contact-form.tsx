...
const fieldClass =
  'border border-line-soft bg-surface px-4 py-3.5 text-[0.95rem] font-light text-cream-bright transition-colors duration-300 placeholder:text-muted-2 focus:border-gold focus:bg-surface-2 focus:outline-none aria-invalid:border-[#b9603f]';

const labelClass = 'text-[0.66rem] uppercase tracking-luxe text-gold';
